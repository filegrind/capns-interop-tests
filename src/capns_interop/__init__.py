...
TEST_CAPS = {
    ...
    "generate_large": 'cap:in="media:report-size;json;textable;form=map";op=generate_large;out="media:sales-report"',
    ...
    "process_large": 'cap:in="media:uploaded-document";op=process_large;out="media:document-info;json;textable;form=map"',
    "hash_incoming": 'cap:in="media:uploaded-document";op=hash_incoming;out="media:document-hash;textable;form=scalar"',
    "verify_binary": 'cap:in="media:package-data";op=verify_binary;out="media:verification-status;textable;form=scalar"',
